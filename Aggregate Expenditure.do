...
****************************************************************************  ;
use "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\bk_sc1.dta" 
keep  hhid14_9  hhid14 sc01_14_14 sc02_14_14 sc03_14_14 sc05
 gen provid14=sc01_14_14
 gen double kabid07=sc01_14_14*100+sc02_14_14 
 gen double kecid07=(kabid07*1000)+sc03_14_14 
 sort hhid14 
 sort hhid14 
 gen rural=(sc05~=1)
 save "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\bk_sc.dta",replace
 
use hhid14 commid14 result14 if hhid14~="" using "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\htrack.dta", clear 
  gen com34=real(substr(commid14,3,2)) 
  gen origea14=(com34~=.) 
  lab var origea "In IFLS EA 14" 
  drop com34  
  sort hhid14 
merge 1:1 hhid14 using "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\bk_sc.dta"
 keep if _merge==3
 drop _merge
 save "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\htrack.dta", replace 
...
****************************************************************************  ;
use hhid14 kr03 kr04a kr04ax kr05a kr05ax using "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\b2_kr.dta" , clear
...
tab1 _outlier*  
sort hhid14  
save "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\tempkr07", replace  
* II.2 Merge with kecid, kabid, information  ;
****************************************************************************  ;
use "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\htrack.dta", clear  
sort hhid14  
merge 1:1 hhid14 using  "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\tempkr07"
tab _merge 
keep if _merge==3  
drop _merge  
...
save "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\b2_kr07", replace  
...
****************************************************************************  ;
use hhid14 ks02 ks03 ks1type using "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\b1_ks1", clear  
...
aorder  
sort hhid14 
save "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\b1_ks107wide", replace 
compress  
...
use "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\htrack.dta", clear  
sort hhid14  
merge 1:1 hhid14 using "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\b1_ks107wide"  
tab _merge  
keep if _merge==3  
drop _merge  
...
save "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\b1_ks114", replace  
...
****************************************************************************  ;
use hhid14 ks2type ks06 using "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\b1_ks2", clear  
...
save "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\b1_ks207_wide", replace  
 
* IV.5. Merge with commid, kecid, kabid info  ;
****************************************************************************  ;
use hhid* kecid kabid commid14 rural origea using "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\htrack.dta", clear  
sort hhid14  
merge 1:1 hhid14 using "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\b1_ks207_wide"
tab _merge  
...
sort hhid14 
save "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\b1_ks214", replace  
...
****************************************************************************  ;
use ks08 ks09a ks3type hhid14 using "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\b1_ks3", clear  
...
save "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\b1_ks307_wide", replace  

*V.3 Merge with kecamatan ID information  ;
****************************************************************************  ;

use "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\b1_ks307_wide", clear  
sort hhid14  
save "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\tempks307", replace 

use hhid*  commid14 kecid kabid origea rural using "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\htrack", clear  
sort hhid14  
merge 1:1 hhid14 using "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\tempks307"  
tab _merge  
...
save "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\b1_ks314", replace  

********************************************************************************  ;
* VI. B1_KS0  ;
********************************************************************************  ;
use  hhid14 ks04b ks07a ks10aa ks10ab ks11aa ks11ab ks12aa ks12ab ks12bb using "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\b1_ks0", clear  
bys hhid14: keep if _n==_N 
...
merge 1:1 hhid14 using "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\htrack"  
tab _merge  
keep if _merge==3  
drop _merge  
...
save "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\b1_ks014", replace  

************************************************************************************  ;
* VII. MERGE ALL EXPENDITURE FILES  ;
************************************************************************************  ;
use "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\b1_ks014", clear  
merge 1:1 hhid14  using "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\b1_ks114"
tab _merge  
rename _merge _m1  
sort hhid14  
 
merge 1:1 hhid14  using "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\b1_ks214"  
tab _merge  
rename _merge _m2   
sort hhid14
   
merge 1:1 hhid14  using "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\b1_ks314"
tab _merge  
rename _merge _m3  
sort hhid14

merge 1:1 hhid14  using "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\b2_kr07"  
tab _merge  
...
save "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\pre_pce14.dta", replace  

******************************************************************************  ;
*VIII. PCE    ;
******************************************************************************  ;
use "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\pre_pce14.dta",clear 
...
drop ks0*   
compress  
save "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\pce07_wo_hhsize.dta", replace  

**************************************************************************************************** ;
* IX. MERGE WITH HHSIZE.DTA,  DATA FROM AR WITH INFO ON HHSIZE (AR01==1 OR 5) ;
*************************************************************************************************   ;
use hhid14 ar00 ar01a if ar01a==1 | ar01a==2 | ar01a==5 | ar01a==11 using  "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\bk_ar1", clear  
bys hhid14 ar00: keep if _n==_N 
bys hhid14: gen hhsize=_N  
bys hhid14: keep if _n==_N 
lab var hhsize "HH size"  
sort hhid14
save  "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\hhsize14", replace  

merge 1:1 hhid14  using  "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\pce07_wo_hhsize.dta"  
...
lab var hhid14 "Household ID 2014" 
...
rename provid14 provid 
rename kabid07 kabid 
rename kecid07 kecid 
rename origea14 origea 
...
keep hhid14 commid14 prov kabid kecid orige x* m* i* w* _out* hh* *pce hhsize owners
drop miss*

lab data "Per Capita Expenditure 2014"  
sort hhid14  
save  "\\rschfs1x\userrs\a-e\dl969_RS\Desktop\14 Aggregate Expenditure\pce14nom.dta", replace  
